...
(() => {
  ...
  var require_lib = __commonJS({
    "node_modules/cookies-next/lib/index.js"(exports) {
      ...
      var isCookiesFromAppRouterMiddleware = function(cookieStore) {
        if (!cookieStore)
          return false;
        return "set" in cookieStore && typeof cookieStore.getAll === "function" && typeof cookieStore.set === "function";
      };
      ...
      var getCookie2 = function(key, options) {
      ...
      var setCookie2 = function(key, data, options) {
        if (isContextFromAppRouterMiddleware(options)) {
          var req = options.req, res = options.res, restOptions = __rest2(options, ["req", "res"]);
          var payload = __assign2({ name: key, value: data }, restOptions);
          if (req) {
        ...
        var _res;
        if (options) {
          var _a = options, req = _a.req, res = _a.res, _options = __rest2(_a, ["req", "res"]);
          _req = req;
          _res = res;
          _cookieOptions = _options;
        }
        var cookieStr = (0, cookie_1.serialize)(key, stringify(data), __assign2({ path: "/" }, _cookieOptions));
        if (!isClientSide()) {
          if (_res && _req) {
      ...
      var deleteCookie2 = function(key, options) {
        return (0, exports.setCookie)(key, "", __assign2(__assign2({}, options), { maxAge: -1 }));
      };
      exports.deleteCookie = deleteCookie2;
      var hasCookie2 = function(key, options) {
        if (!key)
          return false;
        var cookie = (0, exports.getCookies)(options);
        return cookie.hasOwnProperty(key);
      };
      exports.hasCookie = hasCookie2;
    }
  });
  ...
  var CognitoUserPool = /* @__PURE__ */ function() {
    ...
    _proto.getClientId = function getClientId2() {
  ...
  // src/auth-cognito/UserPool.tsx
  init_live_reload();

  // src/auth-cognito/envVars.tsx
  init_live_reload();
  var getClientId = () => {
    return process.env.NEXT_PUBLIC_CLIENT_ID;
  };

  // src/auth-cognito/SocialNotes.tsx
  init_live_reload();
  var import_cookies_next = __toESM(require_lib(), 1);
  var SocialNotes = class extends CognitoUserPool {
    getIsSocial() {
      const cookieExists = (0, import_cookies_next.hasCookie)("social");
      if (cookieExists) {
        const social = (0, import_cookies_next.getCookie)("social") == "true";
        return social;
      }
      return false;
    }
    setIsSocial(isSocial) {
      const socialStr = isSocial ? "true" : "false";
      (0, import_cookies_next.setCookie)("social", socialStr, { maxAge: 60 * 60 * 24 });
    }
    getIsSignedIn() {
      const cookieExists = (0, import_cookies_next.hasCookie)("signedin");
      if (cookieExists) {
        const signedin = (0, import_cookies_next.getCookie)("signedin") == "true";
        return signedin;
      }
      return false;
    }
    setIsSignedIn(isSignedIn) {
      const signedInStr = isSignedIn ? "true" : "false";
      (0, import_cookies_next.setCookie)("signedin", signedInStr, { maxAge: 60 * 60 * 24 });
    }
    getIdToken() {
      const cookieExists = (0, import_cookies_next.hasCookie)("idToken");
      if (cookieExists) {
        const idToken = (0, import_cookies_next.getCookie)("idToken")?.toString();
        if (idToken) {
          return idToken;
        }
      }
    ...
    clearTokens() {
      (0, import_cookies_next.deleteCookie)("signedin");
      (0, import_cookies_next.deleteCookie)("social");
      (0, import_cookies_next.deleteCookie)("accessToken");
      (0, import_cookies_next.deleteCookie)("idToken");
      (0, import_cookies_next.deleteCookie)("refreshToken");
    }
  };
